...
class ResNet(nn.Module):
    def __init__(self, block, layers, used_layers):
        ...
        if layer3:
            self.layer3 = self._make_layer(block, 256, layers[2],
                                           stride=1, dilation=2)  # 15x15, 7x7 adjust the stride from 2 to 1, add dilation
        ...
        if layer4:
            self.layer4 = self._make_layer(block, 512, layers[3],
                                           stride=1, dilation=4)  # 7x7, 3x3 replace stride with dilation
    ...
    def forward(self, x):
        ...
        p3 = self.layer3(p2)
        p4 = self.layer4(p3)
        out = [x_, p1, p2, p3, p4] #feature pyramid
